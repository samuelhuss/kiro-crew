...
Compresses the XML and encodes it into a URL fragment that opens
directly in app.diagrams.net with the diagram loaded.

Usage:
    python3 drawio_url.py <file.drawio> [--open]
"""
